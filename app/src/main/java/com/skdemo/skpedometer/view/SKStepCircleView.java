package com.skdemo.skpedometer.view;
 ...
 * 显示步数的圆弧
 */
public class SKStepCircleView extends View {
    ...
    // 构造方法
    public SKStepCircleView(Context context) {
        super(context);
    }

    public SKStepCircleView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public SKStepCircleView(Context context, AttributeSet attrs, int defStyleAttr) {
